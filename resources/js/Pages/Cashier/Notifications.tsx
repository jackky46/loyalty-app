...
export default function Notifications({ notifications, unreadCount }: Props) {
    ...
    const markAsRead = async (id: number) => {
        router.post(`/cashier/notifications/${id}/read`, {}, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    const markAllAsRead = async () => {
        router.post('/cashier/notifications/mark-all-read', {}, {
            preserveScroll: true,
            onSuccess: () => {
                    ...
                    <div className="max-w-md mx-auto">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                <Link href="/cashier/dashboard" className="p-1 -ml-1">
